...
#define direcPin 22           // Direction foreward/backward switch
#define recuPin 23            // Brake energy recuperation on/off switch
...
#define coolantCyclePin 13    // Controlling the coolant pump
