...
#define MCU2_TempSensorState_LSB 27
#define MCU2_TempSensorState_LEN 1
#define MCU2_TempSensorState_OK 0
#define MCU2_TempSensorState_ERROR 1
...
#define MCU3_DC_MainWireVolt_LSB 0
#define MCU3_DC_MainWireVolt_LEN 16
#define MCU3_DC_MainWireVolt_CONV_D 0.01
#define MCU3_DC_MainWireVolt_INVALID 0xFFFF
#define MCU3_DC_MainWireCurr_LSB 16
#define MCU3_DC_MainWireCurr_LEN 16
#define MCU3_DC_MainWireCurr_CONV_D 0.01
#define MCU3_DC_MainWireCurr_INVALID 0xFFFF
#define MCU3_MotorPhaseCurr_LSB 32
#define MCU3_MotorPhaseCurr_LEN 16
#define MCU3_MotorPhaseCurr_CONV_D 0.01
#define MCU3_MotorPhaseCurr_INVALID 0xFFFF

// BMS messages
#define BMS_OBC 0x520
#define BMS_OBC_INTERVAL 500
#define BMS_OBC_VoltageSet_LSB 8
#define BMS_OBC_VoltageSet_LEN 16
#define BMS_OBC_VoltageSet_CONV_D 0.1
#define BMS_OBC_CurrentSet_LSB 24
#define BMS_OBC_CurrentSet_LEN 16
#define BMS_OBC_CurrentSet_CONV_D 0.1
#define BMS_OBC_ChargeCommand_LSB 32
#define BMS_OBC_ChargeCommand_LEN 8
#define BMS_OBC_ChargeCommand_ON 0
#define BMS_OBC_ChargeCommand_OFF 1
#define BMS_OBC_ChargeCommand_HEATING_MODE 2
#define BMS_OBC_ChargeCommand_COMPLETED 3
#define BMS1 0x1A0
#define BMS1_INTERVAL 20
#define BMS1_WarningLevel_LSB 0
#define BMS1_WarningLevel_LEN 2
#define BMS1_WarningLevel_OK 0
#define BMS1_WarningLevel_ERROR1 1
#define BMS1_WarningLevel_ERROR2 2
#define BMS1_WarningLevel_ERROR3 3
#define BMS1_BatteryChargeStatus_LSB 2
#define BMS1_BatteryChargeStatus_LEN 2
#define BMS1_BatteryChargeStatus_NOT_CHARGING 0
#define BMS1_BatteryChargeStatus_CHARGING 1
#define BMS1_BatteryChargeStatus_FINISHED 2
#define BMS1_BatteryChargeStatus_STANDBY 3
#define BMS1_NegRelayState_LSB 4
#define BMS1_NegRelayState_LEN 1
#define BMS1_NegRelayState_OPEN 0
#define BMS1_NegRelayState_CLOSE 1
#define BMS1_PosRelayState_LSB 5
#define BMS1_PosRelayState_LEN 1
#define BMS1_PosRelayState_OPEN 0
#define BMS1_PosRelayState_CLOSE 1
#define BMS1_HighVoltageLockStatus_LSB 6
#define BMS1_HighVoltageLockStatus_LEN 1
#define BMS1_HighVoltageLockStatus_CLOSED 0
#define BMS1_HighVoltageLockStatus_OPEN 1
#define BMS1_BatteryChargeStatusFault_LSB 7
#define BMS1_BatteryChargeStatusFault_LEN 1
#define BMS1_BatteryChargeStatusFault_OK 0
#define BMS1_BatteryChargeStatusFault_ERROR 1
#define BMS1_SOC_LSB 8
#define BMS1_SOC_LEN 8
#define BMS1_SOC_CONV_D 0.5
#define BMS1_SOC_INVALID 0xFF
#define BMS1_SOH_LSB 16
#define BMS1_SOH_LEN 8
#define BMS1_SOH_CONV_D 0.5
#define BMS1_SOH_INVALID 0xFF
#define BMS1_AC_DC_LSB 24
#define BMS1_AC_DC_LEN 2
#define BMS1_AC_DC_STOP 0
#define BMS1_AC_DC_NORMAL 1
#define BMS1_AC_DC_HEATING 2
#define BMS1_AC_DC_RESERVED 3
#define BMS1_PrechargeRelayState_LSB 26
#define BMS1_PrechargeRelayState_LEN 1
#define BMS1_PrechargeRelayState_OPEN 0
#define BMS1_PrechargeRelayState_CLOSE 1
#define BMS1_FastChargeRelayState_LSB 27
#define BMS1_FastChargeRelayState_LEN 1
#define BMS1_FastChargeRelayState_OPEN 0
#define BMS1_FastChargeRelayState_CLOSE 1
#define BMS1_PrechargeFinishSts_LSB 28
#define BMS1_PrechargeFinishSts_LEN 1
#define BMS1_PrechargeFinishSts_NOT_FINISHED 0
#define BMS1_PrechargeFinishSts_FINISHED 1
#define BMS1_PrechargeFinishSts_F_LSB 29
#define BMS1_PrechargeFinishSts_F_LEN 1
#define BMS1_PrechargeFinishSts_F_OK 0
#define BMS1_PrechargeFinishSts_F_ERROR 1
#define BMS1_Mode_LSB 30
#define BMS1_Mode_LEN 2
#define BMS1_Mode_STANDBY 0
#define BMS1_Mode_ON 1
#define BMS1_Mode_OFF 2
#define BMS1_Mode_RESERVED 3
#define BMS1_ChargeRelayAdhereDetection_LSB 38
#define BMS1_ChargeRelayAdhereDetection_LEN 1
#define BMS1_ChargeRelayAdhereDetection_OK 0
#define BMS1_ChargeRelayAdhereDetection_ERROR 1
#define BMS1_RelayAdhereDetection_LSB 39
#define BMS1_RelayAdhereDetection_LEN 1
#define BMS1_RelayAdhereDetection_OK 0
#define BMS1_RelayAdhereDetection_ERROR 1
#define BMS1_MaxDischarge_LSB 40
#define BMS1_MaxDischarge_LEN 14
#define BMS1_MaxDischarge_CONV_D 0.1
#define BMS1_MaxDischarge_OFFSET 500
#define BMS1_MaxDischarge_INVALID 0x1FFF
#define BMS1_RollingCounter_LSB 48
#define BMS1_RollingCounter_LEN 4
#define BMS1_BatteryPackCoincidence_LSB 52
#define BMS1_BatteryPackCoincidence_LEN 1
#define BMS1_BatteryPackCoincidence_OK 0
#define BMS1_BatteryPackCoincidence_ERROR 1
#define BMS1_BatteryPackMatching_LSB 53
#define BMS1_BatteryPackMatching_LEN 1
#define BMS1_BatteryPackMatching_OK 0
#define BMS1_BatteryPackMatching_ERROR 1
#define BMS1_InsulationResistance_LSB 54
#define BMS1_InsulationResistance_LEN 1
#define BMS1_InsulationResistance_OK 0
#define BMS1_InsulationResistance_ERROR 1
#define BMS1_HighVoltageLockStatusFault_LSB 55
#define BMS1_HighVoltageLockStatusFault_LEN 1
#define BMS1_HighVoltageLockStatusFault_OK 0
#define BMS1_HighVoltageLockStatusFault_ERROR 1
#define BMS1_CheckSum_LSB 56
#define BMS1_CheckSum_LEN 8
